  ...
  <div class="fixed h-full w-full flex justify-center items-center z-20">
    ...
    <div class="relative bg-white rounded-md" style="width: 36rem;">
      ...
      <div class="p-3 border-gray-200">
        <input class="w-full px-3 py-2 border border-gray-300 rounded outline-none focus:border-gray-400" type="text" v-model="query" v-focus @keyup="getUsers" placeholder="Search users by name or email...">

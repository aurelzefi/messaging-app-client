    ...
    <div class="mt-6 px-6 py-4 bg-white rounded" style="width: 24rem;">
      <form @submit.prevent="login">
        <div>
          ...
          <input class="w-full mt-1 px-3 py-2 border border-gray-300 rounded outline-none focus:border-gray-400" :class="{ 'border-red-700': this.errors.email }"  id="email" type="text" v-model="form.email" v-focus>
